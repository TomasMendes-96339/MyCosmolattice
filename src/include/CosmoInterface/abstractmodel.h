...
#define MakeModel(_ModelName, _ModelParsType) AbstractModel<MakeAbstractModelTemplateArgs(_ModelName, _ModelParsType, double)>
    ...
    public:
        ...
        // --> Averages scalar
        T grad2AvI, grad2AvSI, lap2AvI;
        T pi2AvSI, pi2AvSIM, pi2AvIM, pi2AvI, pi2S2AvI;
        T Ppi2AvI, Pgrad2AvI, Pfld4AvI, Plap2AvI, PfldPiAvI, PfldlapAvI, Pfld2AvI;
