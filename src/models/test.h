#ifndef test_H //Usual macro guard to prevent multiple inclusion
#define test_H
...
// fldS : The actual object which contains the scalar fields.
  ...
  public:
    ...
    double xi,lambda, cutoff, H0, cStar;
   ...
   /////////
    ...
    {
        return  0.5*pow<2>(m)*pow<2>(fldS(0_c)) ;
    }*/

    auto potentialTerms(Tag<1>) // IQuadratic
    {
   ...
   /////////
    ...
    {
      return   lambda*pow<3>(fldS(0_c)) - 2*24*xi*pow<2>(cStar/cutoff)*pow<4>(aDotI/aI)  * (fldS(0_c));
    }	
   ...
   /////////
    ...
    {
      return  lambda*3 * pow<2>(fldS(0_c)) - 2*24*xi*pow<2>(cStar/cutoff)*pow<4>(aDotI/aI) ;
    }
